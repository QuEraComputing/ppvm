...
pub fn bench(
    ...
    let new_b = NewGen::compute_overlap_case_b(&new_entries, b.phase, b.destabilizer);
    ...
    group.bench_function("compute_overlap_case_b/new", |bench| {
        bench.iter(|| {
            std::hint::black_box(NewGen::compute_overlap_case_b(
                &new_entries,
                b.phase,
                b.destabilizer,
            ))
    ...
    let new_a =
        NewGen::compute_overlap_case_a(&new_map, a.phase, a.destabilizer, a.stabilizer, new_mask);
    ...
    group.bench_function("compute_overlap_case_a/new", |bench| {
        bench.iter(|| {
            std::hint::black_box(NewGen::compute_overlap_case_a(
                &new_map,
                a.phase,
                a.destabilizer,
                a.stabilizer,
