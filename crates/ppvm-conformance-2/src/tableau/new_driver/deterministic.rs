...
impl<I: Bitstring, H> Clifford for Driven<I, H> {
...
impl<I: Bitstring, H> CliffordExtensions for Driven<I, H> {
...
impl<I: Bitstring, H> CliffordBatch for Driven<I, H> {
...
impl<I: Bitstring, H> CliffordExtensionsBatch for Driven<I, H> {
...
impl<I: Bitstring, H> TGate for Driven<I, H> {
